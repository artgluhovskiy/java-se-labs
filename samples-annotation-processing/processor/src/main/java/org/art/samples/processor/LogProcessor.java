 ...
 */
@SupportedAnnotationTypes({ProcessorConstants.CONTROLLER_ANNOTATION_NAME, ProcessorConstants.SECURED_ANNOTATION_NAME})
public class LogProcessor extends AbstractProcessor {

    @Override
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (TypeElement annotation : annotations) {
            if ((ProcessorConstants.CONTROLLER_ANNOTATION_NAME.equals(annotation.getQualifiedName().toString()))) {
